...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-25 16:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/42a08e42-cded-487b-bf0f-51967e25a2cf.git
$ cd 42a08e42-cded-487b-bf0f-51967e25a2cf
```
